...
def train_unimodal(log_interval, model, device, train_loader, criterion, optimizer, epoch):
...
def validation_unimodal(model, device, criterion, test_loader, dataset_name):
